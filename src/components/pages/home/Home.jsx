...
const Home = () => {
  return (
    <div className="">
      <Header />
      <div className="w-full p-4 m-auto  md:w-[80%] lg:w-[80%]">
        <Navbar />
      </div>
      <div className="border-t ">
        <div className="w-full px-4 m-auto  md:w-[80%] lg:w-[80%] md:flex gap-9">
          <div className="border-r lg:w-[25%]">
            <div className="w-48 mt-8">
              <div className="flex items-center pr-3 justify-between">
                <p>Woman’s Fashion</p>
                <FontAwesomeIcon icon={faAngleRight} />
              </div>
              <div className="flex items-center pr-3 justify-between mt-3">
                <p>Men’s Fashion</p>
                <FontAwesomeIcon icon={faAngleRight} />
              </div>
          ...
          <div className="bg-footerCol lg:w-[80%] m-auto mt-8">
            <div className=" text-secondaryWhite lg:flex w-[85%] m-auto   items-start mt-10 justify-between ">
              <div className="pt-4 md:flex flex-col md:gap-5 w-full">
                ...
                <h1 className="md:text-4xl lg:text-6xl lg:pr-20">
