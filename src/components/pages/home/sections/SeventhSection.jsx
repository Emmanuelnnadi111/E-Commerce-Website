        ...
        <div className=" w-full">
          <div className="relative">
            <img
              ...
              className="w-full"
            />
            <div className="absolute flex flex-col top-20 md:text-sm bottom-0 lg:text-lg md:top-32 lg:top-44 lg:gap-y-4 text-secondaryWhite md:px-2 p-1 lg:p-7 ">
          ...
          <div className="flex justify-between gap-5 mt-4">
            <div className="bg-footerCol w-full flex justify-center relative p-4 ">
              ...
              <div className="absolute flex flex-col text-xs top-10 md:top-20 p-2 md:p-2 md:text-xs lg:text-lg bottom-0 lg:top-32 text-secondaryWhite ">
            ...
            <div className="bg-footerCol w-full flex justify-center p-4 relative">
              <img
                ...
                alt=""
              />
              <div className="absolute flex flex-col text-xs top-10 md:top-20 p-2 md:text-xs lg:text-lg md:p-2 bottom-0 lg:top-32 text-secondaryWhite ">
